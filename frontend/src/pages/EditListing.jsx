...
const EditListing = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        setFormData({
          ...
          condition: listing.ITEM_CONDITION || listing.CONDITION || 'New',
        ...
        if (listing.IMAGES && listing.IMAGES.length > 0) {
            ...
            setImagePreview(img.startsWith('http') ? img : API_BASE_URL + img);
        }
      } catch (err) {
        console.error(err);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!formData.title || !formData.price || !formData.categoryId || (!imageFile && !imagePreview)) {
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-premium dark:shadow-none p-10 md:p-16 border border-gray-100 dark:border-gray-800 transition-colors duration-300">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-black text-gray-900 dark:text-white mb-4 tracking-tight">Edit Listing</h1>
            <p className="text-gray-500 dark:text-gray-400 font-medium">Update the details of your item.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-black text-gray-700 dark:text-gray-300 uppercase tracking-widest mb-3">Item Image *</label>
