      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        <div className="bg-white rounded-[2.5rem] shadow-premium p-10 md:p-16 border border-gray-100">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-black text-gray-900 mb-4 tracking-tight">Edit Listing</h1>
            <p className="text-gray-500 font-medium">Update the details of your item.</p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="mt-2 flex flex-col items-center">
                  ...
                  <label className={`w-full flex flex-col items-center px-4 py-8 bg-gray-50 text-gray-400 rounded-2xl border-2 border-dashed border-gray-200 cursor-pointer hover:bg-gray-100 hover:border-primary transition-all ${(imageFile || imagePreview) ? 'hidden' : 'flex'}`}>
